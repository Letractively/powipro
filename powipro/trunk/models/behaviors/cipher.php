...
'cipher' => 'auto'
	...
	function setup(&$model, $config = array()) {
		...
		$this->config[$model->name]['cipher'] = $this->_cipherMethod($model);
	...
	public function encrypted (&$model, $value) {
		return $this->encrypt($value, $this->config[$model->name]);
	}
	
	public function decrypted (&$model, $value) {
		return $this->decrypt($value, $this->config[$model->name]);
	}
	 ...
	 */
	private function _cipherMethod(&$model) {
